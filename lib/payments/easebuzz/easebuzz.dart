...
class EaseBuzzWebView extends StatefulWidget {
  final String url;

  const EaseBuzzWebView({Key? key, required this.url}) : super(key: key);

  @override
  State<EaseBuzzWebView> createState() => _EaseBuzzWebViewState();
}

class _EaseBuzzWebViewState extends State<EaseBuzzWebView> {
